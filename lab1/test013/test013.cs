...
namespace test013 {
    ...
    public class PointTests {
        [TestMethod]
        // Проверяем работу сеттера в классе точки
    ...
    public class FigureTests {
        [TestMethod]
        // Проверяем работу метода подсчёта расстояния между точками
        public void Figure_LengthSide_CalculatesCorrectLength() {
            Point A = new Point(0, 0);
            Point B = new Point(0, 3);
            Figure figure = new Figure(A, B, null);
        ...
        // Проверяем работу метода подсчёта периметра квадрата
        [TestMethod]
        ...
        // Проверяем работу метода подсчёта периметра треугольника
        [TestMethod]
